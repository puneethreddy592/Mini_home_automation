...
<head>
  ...
  <style>
    ...
    body { background-color: #efefef; font-family: Arial, sans-serif; }
    .navbar { padding: 10px; background-color: #333; color: white; }
    .container { padding: 20px; }
    .heading { font-weight: bold; }
    .bodytext { margin: 10px 0; }
    .btn { padding: 10px; margin: 5px; backgr
  ...
  <script type="text/javascript">
    ...
    function process() {
      ...
      xmlHttp.send(null);
      setTimeout(process, 1000);  // Recur every second
    }
